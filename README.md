...
- A link to a live site where available

The site is a single-page layout with in-page navigation linking to:
...
```bash
git clone https://github.com/HanneStray/noroff-portfolio.git
```
